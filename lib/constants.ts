...
export const APP_DESCRIPTION = process.env.NEXT_PUBLIC_APP_DESCRIPTION || 'An Amzone clone build with Next.js and Mongodb'
...
export const FREE_SHIPPING_MTN_PRICE = Number(
    process.env.FREE_SHIPPING_MTN_PRICE  || 35
)